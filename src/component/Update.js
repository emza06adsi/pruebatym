...
constructor(props){
    ...
    this.state={
        nombreCompleto:this.props.data.nombreEntrega,
        Direccion:this.props.data.direccion,
        departamento:this.props.data.departamento,
        Telefono:this.props.data.telefono1,
        Ciudad:this.props.data.ciudad,
        CodigoPostal:this.props.data.codigoPostal,
        correo:this.props.data.correo,
        instucciones:this.props.data.instruccionesEntrega        
   ...
   return(
       <React.Fragment>
           <section className="form">
                ...
                <strong> z </strong>
                <Link to="/Insert">Editar direccion</Link>
                </div>
               ...
               <form onSubmit={this.handleSubmit}  className="form-post">
                    ...
                    <button className="btn btn-danger " type="submit">Editar direccion</button>
                    </div>
